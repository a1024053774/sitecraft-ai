...
export type ProviderResult =
  ...
  | { ok: false; error: string; code: "not_configured" | "provider_error" | "invalid_output" | "timeout" | "selected_target_mismatch"; model: string | null; latencyMs: number; attemptCount: number };
